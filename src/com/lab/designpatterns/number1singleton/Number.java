    ...
    public void convertToWords(String number) {
        ...
        if (arrayLength == 10) {
            if (arrayNumber[0] - '0' == 0) {
                ...
                System.out.print(hundred_thousand_million[3]);
            }
            ...
            if (arrayNumber[8] - '0' == 1) {
                System.out.print(teens[arrayNumber[9] + 1 - '0']);
                // System.out.print(hundred_thousand_million[1]);
            } else {
                System.out.print(multiples_of_ten[arrayNumber[8] - '0']);
                // System.out.print(ones[arrayNumber[9] - '0']);

                if (arrayNumber[9] - '0' == 0) {
                    System.out.print("");
                } else {
                    System.out.print(ones[arrayNumber[9] - '0']);
